# anysearch documentation build configuration file, created by
...
try:
    ...
    version = anysearch.__version__
    project = anysearch.__title__
    copyright = anysearch.__copyright__
except Exception:
    version = "0.1"
    project = "anysearch"
...
htmlhelp_basename = "anysearchdoc"
...
texinfo_documents = [
    (
        ...
        "OpenSearch (including both *search and *search-dsl packages)",
        "Miscellaneous",
    ),
]
